$(function () {
  var playerTrack = $("#player-track"),
      ...
      buffInterval = null,
      tFlag = false,
      albums = ['父亲写的散文诗', '济南济南', '遇见'],
      trackNames = ['李健', '陈小熊', '孙燕姿'],
      albumArtworks = ['_1', '_2', '_3'],
      trackUrl = ['http://47.95.121.201/uploads/music/fuqin.mp3', 'http://47.95.121.201/uploads/music/jinan.mp3', 'http://47.95.121.201/uploads/music/yujian.mp3'],
  ...
  function selectTrack(flag) {
    ...
    if (currIndex > -1 && currIndex < albumArtworks.length) {
      ...
      $('#' + currArtwork).addClass('active'); //          bgArtworkUrl = $('#'+currArtwork).attr('src');
      //
